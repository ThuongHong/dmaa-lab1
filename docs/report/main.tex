...
\newcommand{\reportname}{Tiền xử lý dữ liệu}
\newcommand{\reporttitle}{Đồ án 1}
...
\input{content/job_distribution.tex}
\input{content/image_preprocessing.tex}
\input{content/tabular_preprocessing.tex}
\input{content/temporal_preprocessing.tex}
